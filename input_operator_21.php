			...
			<div class="w3-row-padding-">
				...
				<div class="w3-third w3-container">
					...
					<form class="w3-container w3-section" method="get" action="input_operator_check_2.php">
						...
						รหัสพนักงาน 1: <input class="w3-input w3-large" type="text" name="o_id1" placeholder="Scan the barcode" id="o_id1" required><br>
						รหัสพนักงาน 2: <input class="w3-input w3-large" type="text" name="o_id2" placeholder="Scan the barcode" ><br>
