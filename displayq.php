...
<body>
    <?php
        ...
        require("source/display_functions_fin_time.php");
    ...
    <!-- <div class="w3-row-padding" style="height: 720px;"> -->
    	...
    	<!-- Finished Queue -->
        <div class="w3-col l5" style="height: 100%;">
            ...
            <div class="w3-animate-right mySlides">
	            <h1 class="w3-center">คลินิกต้มให้ (A)</h1>
	            ...
	            <?php 
		            ...
		            finish_table($db, 15, $fin, $today, 'คลินิกต้มให้ (A)');
	            ?>
	        	</table>
	        </div>
		...
		<!-- Status -->
        <div class="w3-col l7" style="height: 100%;">
