...
<div class="w3-row-padding w3-section w3-container">
			...
			<div class="w3-row w3-border-bottom">
				...
				<div class="w3-center w3-center w3-xxlarge">
				...
				<?php 
					...
					while($list=odbc_fetch_array($result)){
						...
						$temps3='1';
						$temps4='1';
						if($temps<16&&$temps>9||$temps==102||$temps==30||$temps==31||$temp==103){ //103 คือจัดยาวันอื่นเ เพิ่งเพิ่มมานะ
							if($temps==10){
								$temps2=20;
							}
							if($temps==11){
			...
			<div class="w3-container w3-rest w3-margin-bottom">
				<div class="w3-container w3-center w3-card-2 w3-section">	
					<form method=get name=f1 action='HNfind.php'>	
						...
						<div class="w3-center w3-center w3-xlarge">
					<i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;เลือกวันที่
						</div>
								...
								while($list=odbc_fetch_array($result)){
									...
									if($list2=odbc_fetch_array($result2)){
										...
										echo "<TR>
											...
											<TD><a  href='../check_status/check_status.php?c_date=$c_date&q_name=$q_name'>$pre_id</a></TD>
											<TD>$q_name</TD>
											<TD>$s_name</TD>
											<TD>$c_id</TD>
											<TD>$c_name</TD>
...
<footer class="w3-center w3-section w3-small">
<hr>
    *แผนกห้องยาเปิดบริการเวลา 8:00 น. ถึง 16.00 น.
    <br>
    ติดต่อสอบถามเพิ่มเติมได้ที่ 02-222-1828 ต่อ 163
    <br>
    *Dispensary service operates from 8:00 am to 4.00 pm.
    <br>
    For more information please contact 02-222-1828, internal number: 163
</footer>
