...
// prevent dreamweaver error
	...
	header('refresh: 7; url=out_report_handler.php?pre_id='.$pre_id);
...
<div class="w3-row w3-container w3-card-2 w3-section"  style="width: 75%; margin: auto;">
		...
		<div class="w3-row-padding">
			...
			<div class="w3-third w3-container">
				...
				<p><a id="confirm" class=" w3-btn w3-block w3-green w3-xxlarge" href="out_report_handler.php?pre_id=<?php echo $pre_id; ?>">ยืนยัน</a></p>
				<p><a class=" w3-btn w3-block w3-red w3-xxlarge" href="out_input.php" >ล้มเลิก</a></p>
			 </div>
		</div>
