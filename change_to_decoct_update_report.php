...
<div id="demo">
	<?php 
		...
		//refresh
		header('refresh: 5; url=change_to_decoct_operator_input_handler.php?pre_id='.$pre_id.'&s_id='.$s_id.'&o_id1='.$o_id1.'&o_id2='.$o_id2);
	?>
</div>
	<?php
		require('header.html');
					...
					<div class="w3-row-padding">
						...
						<div class="w3-third w3-container" style="height: 100%">
							...
							<p><a id="confirm" class="w3-button w3-block w3-green w3-xxlarge" 
             					href="change_to_decoct_operator_input_handler.php?pre_id=<?php echo $pre_id;?>&s_id=<?php echo $s_id;?>&o_id1=
