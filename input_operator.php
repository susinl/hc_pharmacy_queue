...
<body>
	<!-- input from pre_id_input_handler -->
		<?php
			...
			$today = date("Y-m-d");
			echo($today);
			//$query2 ="SELECT * FROM vDl WHERE DocDate 
		...
		<div class="w3-container w3-card-2 w3-section"  style="width: 90%; margin: auto;">
			...
			<div class="w3-row-padding-">
				...
				<div class="w3-third w3-container">
					...
					<form class="w3-container w3-section" method="get" action="input_operator_check.php">
				
						รหัสพนักงาน 1: <input class="w3-input w3-large" type="text"  onkeyup="this.value = this.value.toUpperCase();" name="o_id1" placeholder="Scan the barcode" id="o_id1" required >
						<p><a class="w3-btn-block w3-xlarge w3-light-grey" href="input_operator_2.php?pre_id=<?php echo $pre_id; ?>&s_id=<?php echo $s_id; ?>&checkk=1"> ทำ 2 คน </a></p>
						<INPUT TYPE="hidden" name="o_id2" value=''>    
